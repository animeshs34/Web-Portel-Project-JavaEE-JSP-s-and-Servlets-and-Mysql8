 ...
 */
@WebServlet("/resulthome")
public class resulthome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("   <title>Home- Dual Degree RGPV,bhopal</title>");
		...
		out.println("                <li style=\"margin-left: 320px;\"><a href=\"lrf\"><i class=\"icon-sli-login text-size-25 text-dark align-right\"></i>LOGIN</a></li>");
		out.println("            </ul> ");
		out.println("         </div>");
		out.println("       </div>");
		out.println("     </nav>");
		...
		out.println("            <!-- title -->");
		out.println("            <h1 class=\"text-strong\">Choose Your Semester You wish TO See Result</h1>");
		out.println("            <!-- //title -->");
		out.println("            ");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=1\">Semester-1</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=2\">Semester-2</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=3\">Semester-3</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=4\">Semester-4</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=5\">Semester-5</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=6\">Semester-6</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=7\">Semester-7</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=8\">Semester-8</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=9\">Semester-9</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"result?sem=10\">Semester-10</a>");
		out.println("            </div>");
		out.println("            ");
		out.println("          </div>");
		out.println("        ");
