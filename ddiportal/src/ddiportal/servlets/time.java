...
public class time extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("    <title>Dual Degree Student Report</title>");
		...
		out.println("            <!-- title -->");
		out.println("            <h1 class=\"text-strong\">Choose Your Semester You wish to See Time Table for..</h1>");
		out.println("            <!-- //title -->");
		out.println("            ");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"\">Semester-1</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"\">Semester-2</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"\">Semester-3</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"\">Semester-4</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"\">Semester-5</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"https://drive.google.com/open?id=1MdAHH1duwWqcaOdlyA3MG9R-5MqJQz3z\">Semester-6</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"\">Semester-7</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"https://drive.google.com/open?id=1MdAHH1duwWqcaOdlyA3MG9R-5MqJQz3z\">Semester-8</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"\">Semester-9</a>");
		out.println("            </div>");
		out.println("            <div class=\"text-white background-dark h-25\" style=\"margin:10px auto;width:800px;\">");
		out.println("                <a href=\"https://drive.google.com/open?id=1MdAHH1duwWqcaOdlyA3MG9R-5MqJQz3z\">Semester-10</a>");
		out.println("            </div>");
		out.println("            ");
		out.println("          </div>");
		out.println("        ");
